...
FIELD_COMMENTS = {
    "qingxu": {
        ...
        "explosion_count": "炸板家数（问财源提供的真实总数）",
        "explosion_10pct": "10cm炸板家数（当前问财源不提供拆分，暂记为0）",
        "explosion_20pct": "20cm炸板家数（当前问财源不提供拆分，暂记为0）",
        "explosion_rate": "炸板率",
    ...
    "limit_up": {
        ...
        "stock_name": "股票简称",
        "is_limit_up": "是否涨停（该表固定为 True）",
        "data_source": "数据来源",
        "collect_time": "采集时间",
        "is_yizi_limit_up": "是否一字涨停",
        "is_fangliang_limit_up": "是否放量涨停",
        "is_suoliang_limit_up": "是否缩量涨停",
        "is_nishi_limit_up": "是否逆势涨停",
        "is_tzi_limit_up": "是否T字涨停",
        "concept_tags": "涨停原因标签（逗号分隔）",
        "consecutive_days": "连续天数（由几天几板解析）",
        "consecutive_boards": "连续板数（由几天几板解析）",
        "is_first_limit_up": "是否首板",
